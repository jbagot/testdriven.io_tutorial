...
class TestUserService(BaseTestCase):
    ...
    def test_all_users(self):
        ...
        add_user('jordi', 'jordi@montseijordi.com')
        with self.client:
            ...
            self.assertIn('jordi', data['data']['users'][1]['username'])
            self.assertIn('jordi@montseijordi.com', data['data']['users'][1]['email'])
            self.assertIn('success', data['status'])
    ...
    def test_main_with_users(self):
        ...
        self.assertIn(b'<strong>jordi</strong>', response.data)
